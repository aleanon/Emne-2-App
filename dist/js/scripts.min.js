  ...
  `}function createCafeProductCardHtml(e){var t=0===e.unitsInStock;return`
    <article class="product-card ${t?"product-card--inactive":""}">
      <header class="product-card__header" ${t?"":`onclick="openProductInfo(${e.productId})"`}>
        <img class="product-card__image" src="./img/cafe_menu/${e.image}" alt="${e.productName}" width="300" height="300" loading="lazy">
  ...
  `}function createCafeProductInfoOverlayElement(){var e=getProductFromId(model.app.selectedProduct);if(null==e)return null;{let t=document.createElement("section");return t.classList.add("overlay"),t.innerHTML=`
      <section class="overlay__content">
        ...
        <div class="overlay__body">
          <img src='./img/cafe_menu/${e.image}' alt="${e.productName}" class="overlay__image" width="521" height="400" loading="lazy">
...
<div class="order-notice">
  ...
  `}function createCakeProductInfoOverlayElement(){var e=getProductFromId(model.app.selectedProduct);if(null==e)return null;{var a="customizable"===(model.app.selectedProduct=e).type,o=a?model.themeImages[model.inputs.themeCakeMenu.selectedThemeId]:e.image,r=a?model.calculateCustomCakePrice(model.inputs.themeCakeMenu.selectedThemeId,model.inputs.themeCakeMenu.size):model.calculateStandardCakePrice(e.productId,model.inputs.cakeMenu.size);let t=document.createElement("section");return t.classList.add("overlay"),t.innerHTML=`
      <div class="overlay__content">
        ...
        <div class="overlay__body">
          ...
          <img id="cakeImage" src="./img/cakes/${o}" alt="${e.productName}" class="overlay__image" width="521" height="400" loading="lazy">
    ...
    <div class="checkout-container">
      ...
      <div class="time-picker-container">
        ...
        <select id="pickup-time" onchange="updatePickupTime(this.value)">
          ...
          ${generateTimeOptions(a.format("YYYY-MM-DD"))}
        </select>
      </div>
  ...
  `}function isDateSelectable(e){return 0!==dayjs(e).day()}function updateAvailableTimes(e){e=generateTimeOptions(e);document.getElementById("pickup-time").innerHTML='<option value="">Velg tid</option>'+e}function handleDateChange(e){isDateSelectable(e)?(model.inputs.shoppingCart.pickUpSchedule.date=e,console.log("Selected date:",e),updateAvailableTimes(e)):(alert("Søndager er ikke tilgjengelige for henting."),document.getElementById("pickup-date").value="",document.getElementById("pickup-time").innerHTML='<option value="">Velg tid</option>')}function updatePickupTime(e){model.inputs.shoppingCart.pickUpSchedule.time=e,console.log("Selected time:",e)}function goToCustomerInfo(){var e=model.inputs.shoppingCart.pickUpSchedule.date,t=model.inputs.shoppingCart.pickUpSchedule.time;console.log("Checking date and time:",e,t),e&&t?(model.inputs.shoppingCart.case="NameAndNumber",updateView()):alert("Vennligst velg både dato og tid for henting")}function createCustomerInfoView(){return`
    <div class="checkout-container">
