  ...
  return /* HTML*/ `
    <article class="product-card ${isOutOfStock ? 'product-card--inactive' : ''}">
      <header class="product-card__header" ${!isOutOfStock ? `onclick="openProductInfo(${product.productId})"` : ''}>
        <img class="product-card__image" src="./img/cafe_menu/${product.image}" alt="${product.productName}" width="300" height="300" loading="lazy">
    ...
    overlay.innerHTML = /* HTML*/ `
      <section class="overlay__content">
        ...
        <div class="overlay__body">
          <img src='./img/cafe_menu/${product.image}' alt="${product.productName}" class="overlay__image" width="521" height="400" loading="lazy">
